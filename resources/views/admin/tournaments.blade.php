...
<div class="space-y-6">
    ...
    <div class="flex justify-between items-center">
        <div>
            <h2 class="text-2xl font-bold text-primary">Gestione Tornei</h2>
            <p class="text-secondary">Gestisci i tornei della piattaforma</p>
        </div>
    ...
    <div class="stat-card p-12 text-center">
        ...
        <h3 class="text-2xl font-bold text-primary mb-4">Gestione Tornei</h3>
        ...
        <div class="flex justify-center space-x-4">
            <div class="text-center">
                ...
                <p class="text-sm font-medium text-primary">Creazione Tornei</p>
            </div>
            <div class="text-center">
                ...
                <p class="text-sm font-medium text-primary">Gestione Squadre</p>
            </div>
            <div class="text-center">
                ...
                <p class="text-sm font-medium text-primary">Statistiche</p>
            </div>
        </div>
    </div>
</div>
